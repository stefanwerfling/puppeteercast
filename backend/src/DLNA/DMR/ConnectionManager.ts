...
export class ConnectionManager extends DefaultRoute {
    ...
    protected async _soapGetCurrentConnectionIDs(request: Request, response: Response): Promise<void> {
    ...
    protected async _soapGetCurrentConnectionInfo(request: Request, response: Response): Promise<void> {
    ...
    protected async _soapGetProtocolInfo(request: Request, response: Response): Promise<void> {
    ...
    public getExpressRouter(): Router {
        this._get(
            '/dmr/ConnectionManager/desc.xml',
            false,
