...
export class AVTransport extends DefaultRoute {
    ...
    getExpressRouter() {
        this._get('/dmr/AVTransport/desc.xml', false, async (request, response) => {
            response.set('Content-Type', 'text/xml');
            response.send(AVTransport._createDescXml().join());
        }, {
            description: 'DLNA Media Render - AVTransport desc.xml'
        });
        this._post('/dmr/AVTransport/control', false, async (request, response) => {
...
//# sourceMappingURL=AVTransport.js.map